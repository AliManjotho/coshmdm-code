...
from datasets import InterHumanDataset, InterXDataset
from models import *
import copy
from datasets.evaluator_models import BERT
...
def build_models(cfg):
    ...
    checkpoint = torch.load(pjoin('eval_model/bert.ckpt'),map_location="cpu")
    # checkpoint = torch.load(pjoin('checkpoints/bert/model/5.ckpt'),map_location="cpu")
