...
class joints2smpl:
    ...
    def __init__(self, num_frames, device_id, cuda=True):
        ...
        self.init_mean_shape = torch.from_numpy(betas_a).unsqueeze(0).repeat(self.batch_size, 1).float().to(self.device)
